...
import sty from "./PlasmicReviewCard.module.css"; // plasmic-import: eF4NWpQgcn5QqkT/css
  ...
  return (
    true ? (
      ...
      >
        <p.PlasmicImg
          alt={""}
          className={classNames(sty.img__q2Xj)}
        ...
        <p.PlasmicImg
          alt={""}
          className={classNames(sty.img__lUbde)}
