...
import sty from "./PlasmicArticleIntro.module.css"; // plasmic-import: n5CGdqB0PbBsQmF/css
  ...
  return (
    ...
    >
      ...
      {true ? (
        ...
        >
          <div className={classNames(projectcss.all, sty.column___4Sxio)}>
            <p.PlasmicImg
          ...
          <div className={classNames(projectcss.all, sty.column__y9Vpr)}>
            <div
              className={classNames(
                projectcss.all,
                projectcss.__wab_text,
