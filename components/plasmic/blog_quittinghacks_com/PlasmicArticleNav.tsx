...
import sty from "./PlasmicArticleNav.module.css"; // plasmic-import: nfsKTlIOc5LDlze/css
  ...
  return (
    (
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__tvwJi)}>
            <p.PlasmicImg
          ...
          <div className={classNames(projectcss.all, sty.column__oxmTr)}>
            <div
